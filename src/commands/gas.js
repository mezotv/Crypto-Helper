...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(subCommand=> subCommand.setName("ethereum").setDescription("Shows the current ethereum gas price")),
       ...
       .addFields(
           { name: '⚡Fast', value:`> **${data.result.FastGasPrice}**gwei`, inline: false },
           { name: '🚶Normal', value:`> **${data.result.ProposeGasPrice}**gwei`, inline: false },
           { name: '🐢Slow', value: `> **${data.result.SafeGasPrice}**gwei`, inline: false },
       )
       .setTimestamp()
